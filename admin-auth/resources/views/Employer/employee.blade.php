                ...
                <div class="card-body">
                   <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-6">
                         <input id="Employemail" type="email" class="form-control " name="Employemail" value="" required="" autocomplete="email" autofocus=""> 
                         @error('Employemail')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                       </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-6">
                         <input id="phoneNumber" type="text" class="form-control " name="phoneNumber" value="" required="" autocomplete="phonenumber" autofocus=""> 
                         @error('phoneNumber')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                       </div>
